...
% Function for Cloud, cloud Shadow, and Snow Masking 3.3.1
%
% History of revisions:
% Bug fixed for cloud object r <= 3 (Zhe 05/24/2016)
...
%Ö»Êä³öÔÆ
cs_final(cs_final==3)=0;
cs_final(cs_final==1)=0;
cs_final(cs_final==2)=0;
cs_final(cs_final==255)=64;
cs_final(cs_final==4)=255;
